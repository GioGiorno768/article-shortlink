...
// Get all Teknologi articles
const TEKNOLOGI_ARTICLES = ARTICLES.filter((a) => a.category === "Teknologi");

// Get featured (first) and rest
const FEATURED = TEKNOLOGI_ARTICLES[0];
const OTHER_ARTICLES = TEKNOLOGI_ARTICLES.slice(1);
          ...
          <div className="mx-auto max-w-7xl px-6 w-full">
            <div className="max-w-xl">
              ...
              <p className="text-gray-300 text-lg max-w-lg">
                Berita dan informasi terkini seputar perkembangan teknologi,
                inovasi digital, dan transformasi industri teknologi di
                Indonesia dan dunia.
              </p>
              <div className="mt-8 flex items-center gap-4">
                <span className="px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-white text-sm">
                  {TEKNOLOGI_ARTICLES.length} Artikel
                </span>
                <span className="px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-white text-sm">
                  Updated Daily
                </span>
          ...
          >
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-8 flex flex-col justify-center">
                <span className="inline-block px-3 py-1 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 text-xs font-semibold rounded-full mb-4 w-fit">
                  Featured
                </span>
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white leading-tight group-hover:text-indigo-600 transition-colors mb-4">
                  {FEATURED.title}
                </h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {OTHER_ARTICLES.map((article) => (
              ...
              >
                ...
                <h3 className="font-bold text-gray-900 dark:text-white text-lg leading-snug group-hover:text-indigo-600 transition-colors line-clamp-2 mb-2">
                  {article.title}
                </h3>
